...
public class GuiUpgrades extends GuiBase<ContainerBase<? extends IUpgradableBlockInternal>> {
	public GuiUpgrades(ContainerBase<? extends IUpgradableBlockInternal> container) {
		...
		GuiElementExpandableColor energyInfo = addGuiElement(new GuiElementExpandableColor(this, right(22, 22), 125, 70));
		energyInfo.setColor(0xFF00FF00);
		energyInfo.setTexture(IRenderable.getRenderable(PowerUpgradeType.CAPACITOR.getStack()));
		energyInfo.setActualContent(IRenderable.getRenderable(() -> LocalizationHelper.localize("betterchests:gui.upgrades.info.power"), energyInfo.getLocation()));

		GuiElementExpandableColor disableInfo = addGuiElement(new GuiElementExpandableColor(this, energyInfo.getLocation().below(22, 22), 125, 52));
		...
		GuiElementExpandableColor filterInfo = addGuiElement(new GuiElementExpandableColor(this, disableInfo.getLocation().below(22, 22), 125, 52));
