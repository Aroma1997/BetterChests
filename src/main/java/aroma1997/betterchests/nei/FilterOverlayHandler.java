...
import aroma1997.betterchests.ContainerFilter;
...
/**
 * Slightly modified version of the default NEI FilterOverlayHandler
 */
public class FilterOverlayHandler implements IOverlayHandler
{
    ...
    public Slot[][] mapIngredSlots(GuiContainer gui, List<PositionedStack> ingredients)
    {
        ...
        FastTransferManager.clickSlot(gui, ContainerFilter.indexCrafting);
