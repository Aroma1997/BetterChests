...
public class BChestRenderer extends TileEntityChestRenderer {
	...
	private ResourceLocation model = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/tile.betterChest.png");
    ...
    public void renderTileEntityChestAt(TileEntityChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            if (block instanceof BlockChest && i == 0)
            {
                ...
                {
                    FMLLog.severe("Attempted to render a BetterChests chest at %d,  %d, %d that was not a BetterChests chest.",
        ...
        //if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null && par1TileEntityChest.adjacentChestZPosition == null && par1TileEntityChest.adjacentChestXPos == null)
        //{
            ModelChest modelchest = this.chestModel;
            this.func_110628_a(this.model);
